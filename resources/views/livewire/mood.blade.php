<div class="grid grid-cols-10 bg-gray-200">
    ...
    @isset($mood)
        <div class="col-span-10 px-6 mb-3">
            <button wire:click="$emit('updateStep', 3)" type="button" class="w-full inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <!-- Heroicon name: check -->
